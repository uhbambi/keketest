...
const Help = () => {
  ...
  return (
    <div className="content">
      ...
      <p className="modalinfo">{t`Source for pixelplanet on `}<a href="https://git.pixelplanet.fun" target="_blank" rel="noopener noreferrer">git.pixelplanet.fun</a> or <a href={cdn`/legal/process.env.PKG_NAME-process.env.PKG_VERSION.zip`} target="_blank" rel="noopener noreferrer">download here</a>.</p>
